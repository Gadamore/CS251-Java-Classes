...
public class Testing10 {
	public static void test(JFrame frame, JButton[] buttons, JButton newGame, TicTacToe game) {
		...
		buttons[3].doClick();
		delay();
		iData = Arrays.equals(game.data, new int[] { 0, 1, 0, 1, 2, 0, 0, 0, 0 });
		comments += iData ? "" : "The data array contents are not set properly, expected[0, 1, 0, 1, 2, 0, 0, 0, 0]\n";
		...
		iData = Arrays.equals(game.data, new int[] { 2, 1, 2, 1, 2, 1, 1, 2, 1 });
		comments += iData ? "" : "The data array contents are not set properly, expected[2, 1, 2, 1, 2, 1, 1, 2, 1]\n";

		newGame.doClick();
		delay();

		iData = Arrays.equals(game.data, new int[] { 0, 0, 0, 0, 0, 0, 0, 0, 0 });
		comments += iData ? "" : "The data array contents are not set properly after clearing, expected [0, 0, 0, 0, 0, 0, 0, 0, 0]\n";
		...
		iData = Arrays.equals(game.data, new int[] { 2, 0, 1, 0, 2, 1, 0, 0, 2 });
		comments += iData ? "" : "actionListeners were not removed properly, expected [2, 0, 1, 0, 2, 1, 0, 0, 2]\n";
		...
		delay();
		iData = Arrays.equals(game.data, new int[] { 0, 0, 0, 0, 0, 0, 0, 0, 0 });
		comments += iData ? "" : "The data array contents are not set properly, expected [0, 0, 0, 0, 0, 0, 0, 0, 0]\n";
		...
		iData = Arrays.equals(game.data, new int[] { 2, 2, 1, 0, 0, 2, 1, 1, 1 });
		comments += iData ? "" : "actionListeners were not removed properly, expected [2, 2, 1, 0, 0, 2, 1, 1, 1]\n";
